About apache-airflow-providers-redis-feedstock
==============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-redis-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-redis-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-redis
# for installing globally
pixi global install apache-airflow-providers-redis
```
...
It is possible to list all of the versions of `apache-airflow-providers-redis` available on your platform:
...
```
pixi search apache-airflow-providers-redis --channel conda-forge
```
